  ...
  return (
    <div className="overlay-container">
      ...
      <div className={`settings-drawer ${!isOpen ? "collapsed" : ""}`}>
          ...
          <div className="control-group">
            ...
            <div style={{ display: "flex", gap: "8px", alignItems: "stretch" }}>
              <input
                ...
                style={{ paddingRight: "16px", backgroundImage: "none", flex: 1, margin: 0 }} // remove arrow icon
              />
              <button
                type="button"
        ...
        {/* 3D LUT Actions */}
        <div className="control-group">
          <label className="control-label">Hardware 3D LUT (.cube)</label>
          <div className="actions-row">
            ...
            <button className="btn" onClick={onResetLUT} title="Restore default Rec.709 lut">
              <ResetIcon />
              Reset Default
            </button>
          </div>
        ...
        {/* Screen Controls */}
        <div className="control-group">
          <label className="control-label">Screen Layout</label>
          <div className="actions-row">
